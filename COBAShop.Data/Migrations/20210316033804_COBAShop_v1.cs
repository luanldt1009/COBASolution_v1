    ...
    public partial class COBAShop_v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi", "Bánh tráng phơi sương", "banh-trang-phoi-suong-tay-ninh", "Sản phẩm bánh tráng phơi sương", "Sản phẩm bánh tráng phơi sương" },
                    { 2, 2, "vi", "Bánh tráng dẻo", "banh-trang-deo-tay-ninh", "Sản phẩm bánh tráng dẻo", "Sản phẩm bánh tráng dẻo" },
                    { 3, 3, "vi", "Bánh tráng cuộn", "banh-trang-cuon-tay-ninh", "Sản phẩm bánh tráng cuộn", "Sản phẩm bánh tráng cuộn" },
                    { 4, 4, "vi", "Bánh tráng xì-ke", "banh-trang-xi-ke-tay-ninh", "Sản phẩm bánh tráng xì-ke Tây Ninh", "Sản phẩm bánh tráng xì-ke Tây Ninh" },
                    { 5, 5, "vi", "Muối", "muoi-tom-tay-ninh", "Sản phẩm muối tôm Tây Ninh", "Sản phẩm muối tôm Tây Ninh" },
                    { 6, 6, "vi", "Nguyên liệu bánh tráng sỉ/lẻ", "nguyen-lieu-banh-trang-tay-ninh", "Nguyên liệu bánh tráng sỉ/lẻ", "Nguyên liệu bánh tráng sỉ/lẻ" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Bánh tráng trộn xa tế", "Bánh tráng trộn xa tế", "vi", "Bánh tráng trộn xa tế", 1, "banh-trang-tron-xa-te", "Bánh tráng trộn xa tế", "Bánh tráng trộn xa tế" });
